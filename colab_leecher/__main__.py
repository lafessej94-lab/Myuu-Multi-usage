...
async def help_cmd(client, message):
    text = (
        ...
        "  /online_tsundere — menu manuel, choisis quoi traiter\n"
        "  /off_tsundere    — désactive le tracker manuel\n"
        "  /tsundere_test   — force une vérification manuelle\n\n"
        "━━━━━━━━━━━━━━━━━━━━━━━━\n"
        "🟣 <b>Unreal Engine 4 (auto, watchlist hebdo)</b>\n"
        "  /myuu_engine_on  — démarre la surveillance auto\n"
        "  /myuu_engine_off — l'arrête\n"
        "  /myuu_add <nom>  — suit un anime pendant 7 jours\n"
        "  /myuu_list       — watchlist + temps restant\n"
        "  /myuu_remove <id> — retire un anime avant expiration\n"
        "  /unreal_test [nom] — teste le pipeline (bypass watchlist)\n\n"
        "━━━━━━━━━━━━━━━━━━━━━━━━\n"
